...
Player::Player(point spawn_pos, float r, float direction, float speed, float turn_speed, color my_color, double update_time)
    : r(r), direction(direction), speed(speed), turn_speed(turn_speed), my_color(my_color), update_time(update_time)
{
    body[0] = spawn_pos;
}
