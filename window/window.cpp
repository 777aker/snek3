...
{
    check_windows.erase(std::remove(check_windows.begin(), check_windows.end(), this), check_windows.end());
    ...
    glClearColor((float)background.r / 255.0, (float)background.g / 255.0, (float)background.b / 255.0, 1.0);
}
